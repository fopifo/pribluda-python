...
Дефолты: interval_tolerance=0.05, max_qty_ratio=1.10, min_display_repeats=2.
...
def get_detector_configs(symbol: str, min_qty: int, overrides: Dict[str, Any]) -> List[Dict[str, Any]]:
    ...
    base_config = {
        ...
        # Н-013: адаптивный допуск; ПОРОГ 10s — настроенные 5% работают для 10-60s
        ...
        # Н-004: стабильный qty для длинных интервалов
